...
if uploaded:
    ...
    st.info("📁 Please upload the **India_air.csv** dataset to continue.")

    st.markdown("""
    ### Which file to upload?
    Upload the file named **`India_air.csv`** — this is the merged India air quality dataset
    containing records from 26 monitoring stations across multiple Indian cities (2015–2020).

    This file is generated by running the data acquisition section of the project notebook,
    which extracts and merges all individual city CSV files into one unified dataset.

    **Expected File Format:**
    - File name: `India_air.csv`
    - Format: CSV (.csv)
    - Rows: ~29,500 daily air quality records
    - Required columns: `City`, `Date`, `PM2.5`, `PM10`, `NO`, `NO2`, `NOx`, `NH3`, `CO`, `SO2`, `O3`, `Benzene`, `Toluene`, `Xylene`, `AQI`
    """)